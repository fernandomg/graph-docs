...
Once your subgraph has been [deployed to the Subgraph Studio](/developer/deploy-subgraph-studio), you have tested it out, and are ready to put it into production, you can then publish it to the decentralized network.
...
Subgraphs can be published to the decentralized network directly from the Subgraph Studio dashboard by clicking on the __Publish__ button. Once a subgraph is published, it will be available to view in the [Graph Explorer](https://thegraph.com/explorer/).
