...
We are using the same CLI to deploy subgraphs to our [legacy explorer](https://thegraph.com/legacy-explorer/) and to the [Subgraph Studio](https://thegraph.com/studio/). Here are the commands to install graph-cli. This can be done using npm or yarn.
...
Before deploying your actual subgraph you need to create a subgraph in [Subgraph Studio](https://thegraph.com/studio/). We recommend you read our [Studio documentation](/docs/studio/subgraph-studio) to learn more about this. 
