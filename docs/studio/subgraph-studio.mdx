...
Querying subgraphs generates query fees, used to reward [indexers](/docs/indexing) on the Graph network. If you’re a dApp, dApp developer, or subgraph developer, the Studio will empower you to build better subgraphs to power your or your community’s queries. The Studio is comprised of 4 main parts:
