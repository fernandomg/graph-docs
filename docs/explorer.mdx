...
## Network 
In the Network section, you will see global KPIs as well as the ability to switch to a per-epoch basis and analyse the metrics in more detail. This network detail will give you a sense of how the network is performing over time. 
