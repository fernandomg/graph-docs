...
- Create and deploy subgraphs using the CLI
...
Querying subgraphs generates query fees, used to reward [indexers](/docs/network/indexing) on the Graph network. If you’re a dApp, dApp developer, or subgraph developer, the Studio will empower you to build better subgraphs to power your or your community’s queries. The Studio is comprised of 4 main parts:
...
You’ve made it this far - congrats! Publishing your subgraph means that an IPFS hash was generated when you deployed the subgraph within the CLI and is stored in the network’s Ethereum smart contracts. In order to publish your subgraph successfully, you’ll need to go through the following steps:

TODO: Add nader's video
