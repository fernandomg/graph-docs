...
<img src="/img/Share-Forumla.png" alt="Share formula" style={{display: "block", margin: "0 auto 16px auto"}} />
...
Using this formula, we can see that it is actually possible for an indexer who i
